      ...
      <Wrapper>
        ...
        <Bars>
          <div onClick={() => {
            ...
            <commons_1.Navbars pic={<hi_1.HiHome />} routeName="Dashboard" cl={home ? "#f1f1f1" : "white"} bd={home ? "" : "4px solid white"} hov={home ? " #03B903F" : ""}/>
          </div>
          ...
          <div onClick={() => {
            ...
            <commons_1.Navbars pic={<fa_1.FaWallet />} routeName="Register Carrier" cl={wallet ? "#f1f1f1" : "white"} bd={wallet ? "" : "4px solid white"} hov={wallet ? " #03B903" : ""}/>
          </div>
          <div onClick={() => {
            setHome(true);
            setWallet(true);
            ...
            <commons_1.Navbars pic={<gi_1.GiCardPickup />} routeName="Asssign Carrier" cl={notify ? "#f1f1f1" : "white"} bd={notify ? "" : "4px solid white"} hov={notify ? " #03B903" : ""}/>
          </div>
          <div onClick={() => {
            setHome(true);
            setWallet(true);
            ...
            <commons_1.Navbars pic={<ai_1.AiFillMessage />} routeName="View Request" cl={support ? "#f1f1f1" : "white"} bd={support ? "" : "4px solid white"} hov={support ? " #03B903" : ""}/>
          </div>
          <div onClick={() => {
            setHome(true);
            setWallet(true);
...
exports.default = StationSideNav;
