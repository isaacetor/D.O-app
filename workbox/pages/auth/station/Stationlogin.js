...
const Stationlogin = () => {
    ...
    const { handleSubmit, formState: { errors }, register, } = (0, react_hook_form_1.useForm)({
        resolver: (0, yup_1.yupResolver)(stationSchema),
    });
    const posting = (0, react_query_1.useMutation)({
        mutationKey: ["Station"],
        mutationFn: utils_1.loginStation,
        onSuccess: (myStation) => {
            dispatch((0, ReduxState_1.stationLogin)(myStation.data));
