...
const Notify = styled_components_1.default.div `
  ...
  display: flex;
`;
const P4 = styled_components_1.default.button `
  margin: 0;
  /* color: black; */
  font-size: 12px;
  margin-right: 20px;
  ...
  outline: none;
`;
const P3 = styled_components_1.default.div `
  margin: 0;
  color: black;
  font-size: 12px;
  margin-right: 50px;
  ...
  font-weight: 500;
`;
const P2 = styled_components_1.default.div `
  margin: 0;
  color: black;
  font-size: 12px;
  margin-right: 60px;
...
`;
const P1 = styled_components_1.default.div `
  margin: 0;
  color: black;
  font-size: 12px;
  margin-right: 18px;
...
`;
const Msg1 = styled_components_1.default.div `
  width: calc(100% - 20px);
  height: 10vh;
  background-color: #ff440018;
  margin-left: 10px;
...
const Holder = styled_components_1.default.div `
  ...
  align-items: center;
`;
const CoverImg = styled_components_1.default.div `
  width: 40px;
  height: 40px;
  border-radius: 50%;
...
`;
const Record = styled_components_1.default.div `
  width: calc(100% - 50px);
...
`;
const Bottom1 = styled_components_1.default.div `
  width: 95%;
  height: 45vh;
